...
class Text_to_Image:
    def __init__(self, cap, n_list=0):
        ...
        self.font = ImageFont.truetype('/home/suneung/gulim.ttf', self.target_shape[0]*3 // 4)
        self.font2 = ImageFont.truetype('/home/suneung/gulim.ttf', self.target_shape[0]*3 // 4)
